(function(){
  ...
  const SUB_ROUTES_UNDER_MORE = ['learning', 'shipping', 'projects', 'achievements'];
  ...
  navigate(['dashboard','vision','goals','daily','more','learning','shipping','projects','achievements'].includes(startRoute) ? startRoute : 'dashboard');
})();
